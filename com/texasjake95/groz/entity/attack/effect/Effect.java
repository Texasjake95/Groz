package com.texasjake95.groz.entity.attack.effect;

import com.texasjake95.groz.Groz;
import com.texasjake95.groz.entity.EnumMonsterType.EnumStatType;
import com.texasjake95.groz.entity.attack.effect.StatChanger.EnumModifier;
import com.texasjake95.groz.entity.attack.effect.StatChanger.StatModifier;
...
public class Effect implements Comparable<Effect> {
	...
	public boolean canAttack(double d)
	{
		if (Groz.DEBUG)
		{
			GrozLogger.logGame("Effect Chance: " + d, 0);
			GrozLogger.logGame("Attack Chance: " + this.attackChance, 0);
		}
