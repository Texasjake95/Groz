...
public class ZoneBase {
	...
	public static final ZoneBase plainZone = new ZoneBase(new IntPair(0, 0),
			ZoneRef.plainZone.getMonsterList(), 0);
	public static final ZoneBase forestZone = new ZoneBase(new IntPair(0, 1),
			ZoneRef.forestZone.getMonsterList(), 0);
	public static final ZoneBase mountainZone = new ZoneBase(new IntPair(0, 2),
			ZoneRef.maintainZone.getMonsterList(), 0);

	public ZoneBase(IntPair pair, ArrayList<Monster> monsterList,
			int recommendLvl) {
		if (zoneList[pair.getIntX()][pair.getIntY()] != null) {
			System.out.println("There is already a Zone located at"
					+ pair.getIntX() + ", " + pair.getIntY());
