...
public class Entity {
	...
	public void damage(Entity attacker, Attack attack, Random rand, boolean isCrt)
	{
		int EAttack = (int) attacker.preformEffect(EnumStatType.ATK, attacker.stats.getAttack() - rand.nextInt(attacker.stats.getAttack() / 2));
		int Defense = (int) this.preformEffect(EnumStatType.DEF, this.stats.getDefense() - rand.nextInt(this.stats.getDefense() / 2));
	...
	{
		int heal = (int) attacker.preformEffect(EnumStatType.ATK, rand.nextInt(attacker.stats.getAttack() / 2));
