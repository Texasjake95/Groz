...
public class Attack {
	...
	public void doAttack(Entity attacker, Entity victim)
	{
		...
		System.out.println(attacker.getName() + ": " + attacker.getStats().getHealth());
		System.out.println(victim.getName() + ": " + victim.getStats().getHealth());
		System.out.println(attacker.getName() + " MAX: " + attacker.getStats().getMaxHealth());
		System.out.println(victim.getName() + " MAX: " + victim.getStats().getMaxHealth());
		double aglilitya = attacker.preformEffect(EnumStatType.AGL, attacker.getStats().getAgility() - nextInt(attacker.getStats().getAgility() / 2));
		System.out.println(aglilitya);
		double aglilityv = victim.preformEffect(EnumStatType.AGL, victim.getStats().getAgility() - nextInt(victim.getStats().getAgility() / 2));
