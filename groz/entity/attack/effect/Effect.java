...
public class Effect implements Comparable<Effect> {
	...
	private int id;
	public static final Effect Paralyze = new Effect(.50d, 0,
			new StatChanger().addStats(EnumStatType.SPD, EnumModifier.Multiply,
					.5d));
	public static final Effect Sleep = new Effect(0.0, 1, new StatChanger());
	public static final Effect Posion = new Effect(1.0d, 2,
			new StatChanger().addStats(EnumStatType.Health,
					EnumModifier.Subtract, 3));
